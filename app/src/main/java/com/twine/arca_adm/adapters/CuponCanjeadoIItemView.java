 ...
 */
@EViewGroup(R.layout.item_cupon_canjeado)
public class CuponCanjeadoIItemView extends LinearLayout implements ViewWrapper.Binder<Cupon> {
    ...
    public CuponCanjeadoIItemView(Context context) {
        super(context);
    }
